  ...
  return (
    <div className="bg-white h-[160px] w-full flex flex-col justify-center gap-2">
      <div className="w-full h-16">
        <div className="tab w-1/4" onClick={() => setCurrentCategory("all")}>
          <div className="flex flex-col">
            ...
            <div
              className={currentCategory === "all" ? "text-myprimary" : null}
            >
              전체
            </div>
          </div>
        ...
        <div className="tab w-1/4" onClick={() => setCurrentCategory("foods")}>
          <div className="flex flex-col">
            ...
            <div
              className={currentCategory === "foods" ? "text-myprimary" : null}
            >
              먹거리
            </div>
          </div>
        ...
        <div className="tab w-1/4" onClick={() => setCurrentCategory("meats")}>
          <div className="flex flex-col">
            ...
            <div
              className={currentCategory === "meats" ? "text-myprimary" : null}
            >
              축산
            </div>
          </div>
        </div>
        <div className="tab w-1/4" onClick={() => setCurrentCategory("farm")}>
          <div className="flex flex-col">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              height="2em"
              viewBox="0 0 512 512"
              className={currentCategory === "farm" ? "fill-myprimary" : null}
            >
            ...
            <div
              className={currentCategory === "farm" ? "text-myprimary" : null}
            >
              농산물
            </div>
          </div>
      ...
      <div className="w-full h-16">
        <div className="tab w-1/4" onClick={() => setCurrentCategory("fishes")}>
          <div className="flex flex-col">
            ...
            <div
              className={currentCategory === "fishes" ? "text-myprimary" : null}
            >
              수산
            </div>
          </div>
        ...
        <div className="tab w-1/4" onClick={() => setCurrentCategory("dried")}>
          <div className="flex flex-col">
            ...
            <div
              className={currentCategory === "dired" ? "text-myprimary" : null}
            >
              건어물
            </div>
          </div>
        ...
        <div className="tab w-1/4" onClick={() => setCurrentCategory("sides")}>
          <div className="flex flex-col">
            ...
            <div
              className={currentCategory === "sides" ? "text-myprimary" : null}
            >
              반찬
            </div>
          </div>
        ...
        <div className="tab w-1/4" onClick={() => setCurrentCategory("fruits")}>
          <div className="flex flex-col">
            ...
            <div
              className={currentCategory === "fruits" ? "text-myprimary" : null}
            >
              과일
            </div>
          </div>
