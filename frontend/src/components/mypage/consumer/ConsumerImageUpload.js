...
const ConsumerImageUpload = (props) => {
  ...
  const uploadButton = (
    <div
      className="relative w-full pb-[100%] bg-gray-100 rounded-full flex flex-col justify-center"
      onClick={onUploadButtonClicked}
    >
      <div className="absolute top-[35%] left-[35%] flex flex-col items-center">
        <svg
    ...
    <>
      <div className="flex overflow-auto">
        ...
        {props.imageList.length>0? props.imageList.map((image) => (
          <div
            key={image.url}
            className="relative w-[150px] h-[150px] bg-gray-100 rounded-full flex flex-col justify-center"
          >
            <img
              src={image.url}
              alt={image.id}
...
export default ConsumerImageUpload;
