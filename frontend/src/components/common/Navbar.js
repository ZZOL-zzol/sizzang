...
const Navbar = () => {
  ...
  return (
    <div className="btm-nav z-40">
      ...
      <button className={currentTab===1? 'border-t-2 border-myprimary': ''} onClick={()=>{navigate('/place'); dispatch(setCurrentTab(1))}}>
        <svg
      ...
      <button className={currentTab===2? 'border-t-2 border-myprimary': ''} onClick={()=>{navigate('/product'); dispatch(setCurrentTab(2))}}>
        <svg
      ...
      <button className={currentTab===3? 'border-t-2 border-myprimary': ''} onClick={()=>{navigate('/profile'); dispatch(setCurrentTab(3))}}>
        <svg
