...
public class StoreController {
    ...
    public CommonResponse<List<StoreFindRes>> findAllByTag(@PathVariable int tagCode) {
        log.info("StoreController_findAllByTag_start: ");

        Optional<List<StoreFindRes>> findRes = Optional.ofNullable(
                storeService.findStoreCodeByTag(tagCode));

        log.info("StoreController_findAllByTag_end: " + findRes);
        return CommonResponse.success(findRes.orElseThrow(TemplateNoResultException::new));
    }
}
